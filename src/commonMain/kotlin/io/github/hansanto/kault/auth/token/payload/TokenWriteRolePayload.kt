...
public data class TokenWriteRolePayload(
    ...
    public val allowedPolicies: List<String>? = null,
    ...
    public val disallowedPolicies: List<String>? = null,
    ...
    public val allowedPoliciesGlob: List<String>? = null,
    ...
    public val disallowedPoliciesGlob: List<String>? = null,
     ...
     */
    @SerialName("orphan")
    public val orphan: Boolean? = null,
    ...
    public val renewable: Boolean? = null,
    ...
    public val pathSuffix: String? = null,
    ...
    public val allowedEntityAliases: List<String>? = null,

    /**
     * List of CIDR blocks; if set, specifies blocks of IP addresses which can authenticate successfully, and ties the resulting token to these blocks as well.
     */
    @SerialName("token_bound_cidrs")
    public val tokenBoundCidrs: List<String>? = null,
    ...
    public val tokenExplicitMaxTTL: VaultDuration? = null,
