...
@Serializable
public data class AuthOIDCReadRoleResponse(
    /**
    ...
    public val allowedRedirectUris: List<String>,

    /**
     * Type of role.
     */
    @SerialName("role_type")
    public val roleType: OIDCRoleType,
    ...
    public val userClaimJsonPointer: Boolean,
    ...
    public val clockSkewLeeway: VaultDuration,
    ...
    public val expirationLeeway: VaultDuration,
    ...
    public val notBeforeLeeway: VaultDuration,

    /**
     * If set, requires that the 'sub' claim matches this value.
     */
    @SerialName("bound_subject")
    public val boundSubject: String,
    ...
    public val boundClaims: Map<String, String>?,
    ...
    public val boundClaimsType: OIDCBoundClaimsType,
    ...
    public val claimMappings: Map<String, String>?,
    ...
    public val oidcScopes: List<String>?,
    ...
    public val verboseOIDCLogging: Boolean,
     ...
     */
    @SerialName("max_age")
    public val maxAge: VaultDuration,
