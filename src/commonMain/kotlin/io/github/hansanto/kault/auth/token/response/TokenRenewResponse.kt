...
/**
 * Build an instance of [TokenInfo] from the [TokenRenewResponse].
 * @receiver The response from the renew token request.
 * @return All information about the new token.
 */
public fun TokenRenewResponse.toTokenInfo(): TokenInfo = TokenInfo(
    token = clientToken,
    accessor = accessor,
...
@Serializable
public data class TokenRenewResponse(
