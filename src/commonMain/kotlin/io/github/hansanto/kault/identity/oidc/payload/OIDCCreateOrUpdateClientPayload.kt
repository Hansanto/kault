...
@Serializable
public data class OIDCCreateOrUpdateClientPayload(
    /**
    ...
    public var assignments: List<String>? = null,
    ...
    public var clientType: ClientType? = null,
    ...
    public var idTokenTTL: VaultDuration? = null,
    ...
    public var accessTokenTTL: VaultDuration? = null
)
